...
Write-Host ""
Write-Host "   NOTE: Always use 'npx prisma' on Windows. Do NOT run node.exe on the"
Write-Host "   .cmd shim file, as it's a batch file and will fail. npx handles this correctly."
Write-Host ""
